...
class BottomNavigationViewV16x : BottomNavigationView,
    ...
    override fun setIconVisibility(visibility: Boolean): BottomNavigationViewV16x {
    ...
    override fun setTextVisibility(visibility: Boolean): BottomNavigationViewV16x {
    ...
    override fun enableAnimation(enable: Boolean): BottomNavigationViewV16x {
        for (b in theBottomNavigationItemViews) {
            val largeLabel: TextView = b.getFieldValue("largeLabel")
            val smallLabel: TextView = b.getFieldValue("smallLabel")
    ...
    override fun enableLabelVisibility(enable: Boolean): BottomNavigationViewV16x {
        labelVisibilityMode = if (enable) LABEL_VISIBILITY_SELECTED else LABEL_VISIBILITY_LABELED
        return this
    }
    
    override fun enableBNItemViewLabelVisibility(position: Int, enable: Boolean): BottomNavigationViewV16x {
        getBNItemView(position)?.setShifting(enable)
        return this
    }
    
    override fun enableItemHorizontalTranslation(enable: Boolean): BottomNavigationViewV16x {
    ...
    override fun setCurrentItem(index: Int): BottomNavigationViewV16x {
    ...
    override fun setMenuListener(menuListener: IMenuListener): BottomNavigationViewV16x {
        bnvHelper.setListener(menuListener)
        return this
    }
    
    override fun setMenuDoubleClickListener(menuDoubleClickListener: IMenuDoubleClickListener): BottomNavigationViewV16x {
    ...
    override fun clearIconTintColor(): BottomNavigationViewV16x {
    ...
    override fun setSmallTextSize(sp: Float): BottomNavigationViewV16x {
    ...
    override fun setLargeTextSize(sp: Float): BottomNavigationViewV16x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setTextSize(sp: Float): BottomNavigationViewV16x {
        setLargeTextSize(sp)
        setSmallTextSize(sp)
        return this
    }
    ...
    override fun setIconSize(width: Float, height: Float): BottomNavigationViewV16x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setIconSize(dpSize: Float): BottomNavigationViewV16x {
        itemIconSize = context.dp2px(dpSize)
        return this
    }
    
    override fun setBNMenuViewHeight(height: Int): BottomNavigationViewV16x {
        Log.d("EX150", "setBNMenuViewHeight: ${layoutParams.height}")
        val lp = layoutParams
    ...
    override fun getBNMenuViewHeight(): Int {
        Log.d("EX150", "getBNMenuViewHeight: ${layoutParams.height}")
        return itemHeight //theBottomNavigationMenuView.getField("itemHeight")
    }
    
    override fun setTypeface(typeface: Typeface, style: Int): BottomNavigationViewV16x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setTypeface(typeface: Typeface): BottomNavigationViewV16x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setBNItemViewBackgroundRes(position: Int, background: Int): BottomNavigationViewV16x {
        getBNItemView(position)?.setItemBackground(background)
        return this
    }
    
    override fun setIconTintList(tint: ColorStateList?): BottomNavigationViewV16x {
        theBottomNavigationMenuView.iconTintList = tint
        return this
    }
    
    override fun setIconTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV16x {
        getBNItemView(position)?.setIconTintList(tint)
        return this
    }
    
    override fun setTextTintList(tint: ColorStateList?): BottomNavigationViewV16x {
        theBottomNavigationMenuView.itemTextColor = tint
        return this
    }
    
    override fun setTextTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV16x {
        getBNItemView(position)?.setTextColor(tint)
        return this
    }
    
    override fun setIconsMarginTop(marginTop: Int): BottomNavigationViewV16x {
    ...
    override fun setIconMarginTop(position: Int, marginTop: Int): BottomNavigationViewV16x {
    ...
    override fun setEmptyMenuIds(emptyMenuIds: List<Int>): BottomNavigationViewV16x {
        bnvHelper.emptyMenuIds = emptyMenuIds
        return this
    }
    
    override fun configDynamic(count: Int, generator: (menu: Menu, index: Int) -> MenuItem): BottomNavigationViewV16x {
        if(count > 0) {
