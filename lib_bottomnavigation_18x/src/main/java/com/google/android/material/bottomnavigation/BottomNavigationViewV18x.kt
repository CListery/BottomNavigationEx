...
class BottomNavigationViewV18x : BottomNavigationView,
    ...
    override fun setIconVisibility(visibility: Boolean): BottomNavigationViewV18x {
    ...
    override fun setTextVisibility(visibility: Boolean): BottomNavigationViewV18x {
    ...
    override fun enableAnimation(enable: Boolean): BottomNavigationViewV18x {
        for(b in theBottomNavigationItemViews) {
            val largeLabel: TextView = b.getFieldValue("largeLabel")
            val smallLabel: TextView = b.getFieldValue("smallLabel")
    ...
    override fun enableLabelVisibility(enable: Boolean): BottomNavigationViewV18x {
        labelVisibilityMode = if(enable) LABEL_VISIBILITY_SELECTED else LABEL_VISIBILITY_LABELED
        return this
    }
    
    override fun enableBNItemViewLabelVisibility(position: Int, enable: Boolean): BottomNavigationViewV18x {
        getBNItemView(position)?.setShifting(enable)
        return this
    }
    
    override fun enableItemHorizontalTranslation(enable: Boolean): BottomNavigationViewV18x {
    ...
    override fun setCurrentItem(index: Int): BottomNavigationViewV18x {
    ...
    override fun setMenuListener(menuListener: IMenuListener): BottomNavigationViewV18x {
        bnvHelper.setListener(menuListener)
        return this
    }
    
    override fun setMenuDoubleClickListener(menuDoubleClickListener: IMenuDoubleClickListener): BottomNavigationViewV18x {
    ...
    override fun clearIconTintColor(): BottomNavigationViewV18x {
    ...
    override fun setSmallTextSize(sp: Float): BottomNavigationViewV18x {
    ...
    override fun setLargeTextSize(sp: Float): BottomNavigationViewV18x {
        val count = getBNItemViewCount()
        for(i in 0 until count) {
    ...
    override fun setTextSize(sp: Float): BottomNavigationViewV18x {
        setLargeTextSize(sp)
        setSmallTextSize(sp)
        return this
    }
    ...
    override fun setIconSize(width: Float, height: Float): BottomNavigationViewV18x {
        val count = getBNItemViewCount()
        for(i in 0 until count) {
    ...
    override fun setIconSize(dpSize: Float): BottomNavigationViewV18x {
        itemIconSize = context.dp2px(dpSize)
        return this
    }
    
    override fun setBNMenuViewHeight(height: Int): BottomNavigationViewV18x {
        val lp = layoutParams
    ...
    override fun setTypeface(typeface: Typeface, style: Int): BottomNavigationViewV18x {
        val count = getBNItemViewCount()
        for(i in 0 until count) {
    ...
    override fun setTypeface(typeface: Typeface): BottomNavigationViewV18x {
        val count = getBNItemViewCount()
        for(i in 0 until count) {
    ...
    override fun setBNItemViewBackgroundRes(position: Int, background: Int): BottomNavigationViewV18x {
        getBNItemView(position)?.setItemBackground(background)
        return this
    }
    
    override fun setIconTintList(tint: ColorStateList?): BottomNavigationViewV18x {
        theBottomNavigationMenuView.iconTintList = tint
        return this
    }
    
    override fun setIconTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV18x {
        getBNItemView(position)?.setIconTintList(tint)
        return this
    }
    
    override fun setTextTintList(tint: ColorStateList?): BottomNavigationViewV18x {
        theBottomNavigationMenuView.itemTextColor = tint
        return this
    }
    
    override fun setTextTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV18x {
        getBNItemView(position)?.setTextColor(tint)
        return this
    }
    
    override fun setIconsMarginTop(marginTop: Int): BottomNavigationViewV18x {
    ...
    override fun setIconMarginTop(position: Int, marginTop: Int): BottomNavigationViewV18x {
    ...
    override fun setEmptyMenuIds(emptyMenuIds: List<Int>): BottomNavigationViewV18x {
        bnvHelper.emptyMenuIds = emptyMenuIds
        return this
    }
    
    override fun configDynamic(count: Int, generator: (menu: Menu, index: Int) -> MenuItem): BottomNavigationViewV18x {
        if(count > 0) {
