...
class BottomNavigationViewV150 : BottomNavigationView,
    ...
    override fun setIconVisibility(visibility: Boolean): BottomNavigationViewV150 {
    ...
    override fun setTextVisibility(visibility: Boolean): BottomNavigationViewV150 {
    ...
    override fun enableAnimation(enable: Boolean): BottomNavigationViewV150 {
        for (b in theBottomNavigationItemViews) {
            val largeLabel: TextView = b.getField("largeLabel")
            val smallLabel: TextView = b.getField("smallLabel")
    ...
    override fun enableLabelVisibility(enable: Boolean): BottomNavigationViewV150 {
        labelVisibilityMode = if (enable) LABEL_VISIBILITY_SELECTED else LABEL_VISIBILITY_LABELED
        return this
    }
    
    override fun enableBNItemViewLabelVisibility(position: Int, enable: Boolean): BottomNavigationViewV150 {
        getBNItemView(position)?.setShifting(enable)
        return this
    }
    
    override fun enableItemHorizontalTranslation(enable: Boolean): BottomNavigationViewV150 {
    ...
    override fun setCurrentItem(index: Int): BottomNavigationViewV150 {
    ...
    override fun setMenuListener(menuListener: IMenuListener): BottomNavigationViewV150 {
        bnvHelper.setListener(menuListener)
        return this
    }
    
    override fun setMenuDoubleClickListener(menuDoubleClickListener: IMenuDoubleClickListener): BottomNavigationViewV150 {
    ...
    override fun clearIconTintColor(): BottomNavigationViewV150 {
    ...
    override fun setSmallTextSize(sp: Float): BottomNavigationViewV150 {
    ...
    override fun setLargeTextSize(sp: Float): BottomNavigationViewV150 {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setTextSize(sp: Float): BottomNavigationViewV150 {
        setLargeTextSize(sp)
        setSmallTextSize(sp)
        return this
    }
    ...
    override fun setIconSize(width: Float, height: Float): BottomNavigationViewV150 {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setIconSize(dpSize: Float): BottomNavigationViewV150 {
        itemIconSize = context.dp2px(dpSize)
        return this
    }
    
    override fun setBNMenuViewHeight(height: Int): BottomNavigationViewV150 {
        val lp = layoutParams
    ...
    override fun setTypeface(typeface: Typeface, style: Int): BottomNavigationViewV150 {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setTypeface(typeface: Typeface): BottomNavigationViewV150 {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setBNItemViewBackgroundRes(position: Int, background: Int): BottomNavigationViewV150 {
        getBNItemView(position)?.setItemBackground(background)
        return this
    }
    
    override fun setIconTintList(tint: ColorStateList?): BottomNavigationViewV150 {
        theBottomNavigationMenuView.iconTintList = tint
        return this
    }
    
    override fun setIconTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV150 {
        getBNItemView(position)?.setIconTintList(tint)
        return this
    }
    
    override fun setTextTintList(tint: ColorStateList?): BottomNavigationViewV150 {
        theBottomNavigationMenuView.itemTextColor = tint
        return this
    }
    
    override fun setTextTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV150 {
        getBNItemView(position)?.setTextColor(tint)
        return this
    }
    
    override fun setIconsMarginTop(marginTop: Int): BottomNavigationViewV150 {
    ...
    override fun setIconMarginTop(position: Int, marginTop: Int): BottomNavigationViewV150 {
    ...
    override fun setEmptyMenuIds(emptyMenuIds: List<Int>): BottomNavigationViewV150 {
