...
class BottomNavigationMenuView2 : BottomNavigationMenuView {
    ...
    constructor(context: Context, originMenuView: BottomNavigationMenuView) : this(context) {
        ...
        setFieldValue("itemTextColorDefault", originMenuView.getFieldValue("itemTextColorDefault"))
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        var totalWidth = 0
        val itemWidth = if(totalCount > BottomNavigationMenu.MAX_ITEM_COUNT) {
            min(activeItemMaxWidth, width / BottomNavigationMenu.MAX_ITEM_COUNT)
