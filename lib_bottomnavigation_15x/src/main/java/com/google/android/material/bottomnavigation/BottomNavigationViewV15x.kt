...
class BottomNavigationViewV15x : BottomNavigationView,
    ...
    override fun setIconVisibility(visibility: Boolean): BottomNavigationViewV15x {
    ...
    override fun setTextVisibility(visibility: Boolean): BottomNavigationViewV15x {
    ...
    override fun enableAnimation(enable: Boolean): BottomNavigationViewV15x {
        for (b in theBottomNavigationItemViews) {
            val largeLabel: TextView = b.getFieldValue("largeLabel")
            val smallLabel: TextView = b.getFieldValue("smallLabel")
    ...
    override fun enableLabelVisibility(enable: Boolean): BottomNavigationViewV15x {
        labelVisibilityMode = if (enable) LABEL_VISIBILITY_SELECTED else LABEL_VISIBILITY_LABELED
        return this
    }
    
    override fun enableBNItemViewLabelVisibility(position: Int, enable: Boolean): BottomNavigationViewV15x {
        getBNItemView(position)?.setShifting(enable)
        return this
    }
    
    override fun enableItemHorizontalTranslation(enable: Boolean): BottomNavigationViewV15x {
    ...
    override fun setCurrentItem(index: Int): BottomNavigationViewV15x {
    ...
    override fun setMenuListener(menuListener: IMenuListener): BottomNavigationViewV15x {
        bnvHelper.setListener(menuListener)
        return this
    }
    
    override fun setMenuDoubleClickListener(menuDoubleClickListener: IMenuDoubleClickListener): BottomNavigationViewV15x {
    ...
    override fun clearIconTintColor(): BottomNavigationViewV15x {
    ...
    override fun setSmallTextSize(sp: Float): BottomNavigationViewV15x {
    ...
    override fun setLargeTextSize(sp: Float): BottomNavigationViewV15x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setTextSize(sp: Float): BottomNavigationViewV15x {
        setLargeTextSize(sp)
        setSmallTextSize(sp)
        return this
    }
    ...
    override fun setIconSize(width: Float, height: Float): BottomNavigationViewV15x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setIconSize(dpSize: Float): BottomNavigationViewV15x {
        itemIconSize = context.dp2px(dpSize)
        return this
    }
    
    override fun setBNMenuViewHeight(height: Int): BottomNavigationViewV15x {
        val lp = layoutParams
    ...
    override fun setTypeface(typeface: Typeface, style: Int): BottomNavigationViewV15x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setTypeface(typeface: Typeface): BottomNavigationViewV15x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setBNItemViewBackgroundRes(position: Int, background: Int): BottomNavigationViewV15x {
        getBNItemView(position)?.setItemBackground(background)
        return this
    }
    
    override fun setIconTintList(tint: ColorStateList?): BottomNavigationViewV15x {
        theBottomNavigationMenuView.iconTintList = tint
        return this
    }
    
    override fun setIconTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV15x {
        getBNItemView(position)?.setIconTintList(tint)
        return this
    }
    
    override fun setTextTintList(tint: ColorStateList?): BottomNavigationViewV15x {
        theBottomNavigationMenuView.itemTextColor = tint
        return this
    }
    
    override fun setTextTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV15x {
        getBNItemView(position)?.setTextColor(tint)
        return this
    }
    
    override fun setIconsMarginTop(marginTop: Int): BottomNavigationViewV15x {
    ...
    override fun setIconMarginTop(position: Int, marginTop: Int): BottomNavigationViewV15x {
    ...
    override fun setEmptyMenuIds(emptyMenuIds: List<Int>): BottomNavigationViewV15x {
        bnvHelper.emptyMenuIds = emptyMenuIds
        return this
    }
    
    override fun configDynamic(count: Int, generator: (menu: Menu, index: Int) -> MenuItem): BottomNavigationViewV15x {
        if(count > 0) {
