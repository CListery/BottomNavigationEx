...
class BottomNavigationViewV14x : BottomNavigationView,
    ...
    override fun setTextVisibility(visibility: Boolean): BottomNavigationViewV14x {
    ...
    override fun enableLabelVisibility(enable: Boolean): BottomNavigationViewV14x {
        labelVisibilityMode = if (enable) LABEL_VISIBILITY_SELECTED else LABEL_VISIBILITY_LABELED
        return this
    }

    override fun enableBNItemViewLabelVisibility(position: Int, enable: Boolean): BottomNavigationViewV14x {
        getBNItemView(position)?.setShifting(enable)
        return this
    }

    override fun enableItemHorizontalTranslation(enable: Boolean): BottomNavigationViewV14x {
    ...
    override fun setCurrentItem(index: Int): BottomNavigationViewV14x {
    ...
    override fun setMenuListener(menuListener: IMenuListener): BottomNavigationViewV14x {
        bnvHelper.setListener(menuListener)
        return this
    }

    override fun setMenuDoubleClickListener(menuDoubleClickListener: IMenuDoubleClickListener): BottomNavigationViewV14x {
    ...
    override fun clearIconTintColor(): BottomNavigationViewV14x {
    ...
    override fun setSmallTextSize(sp: Float): BottomNavigationViewV14x {
    ...
    override fun setLargeTextSize(sp: Float): BottomNavigationViewV14x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setTextSize(sp: Float): BottomNavigationViewV14x {
        setLargeTextSize(sp)
        setSmallTextSize(sp)
        return this
    }
    ...
    override fun setIconSize(width: Float, height: Float): BottomNavigationViewV14x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setIconSize(dpSize: Float): BottomNavigationViewV14x {
    ...
    override fun setTypeface(typeface: Typeface): BottomNavigationViewV14x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setBNItemViewBackgroundRes(position: Int, background: Int): BottomNavigationViewV14x {
        getBNItemView(position)?.setItemBackground(background)
        return this
    }

    override fun setIconTintList(tint: ColorStateList?): BottomNavigationViewV14x {
        theBottomNavigationMenuView.iconTintList = tint
        return this
    }

    override fun setIconTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV14x {
        getBNItemView(position)?.setIconTintList(tint)
        return this
    }

    override fun setTextTintList(tint: ColorStateList?): BottomNavigationViewV14x {
        theBottomNavigationMenuView.itemTextColor = tint
        return this
    }

    override fun setTextTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV14x {
        getBNItemView(position)?.setTextColor(tint)
        return this
    }

    override fun setIconsMarginTop(marginTop: Int): BottomNavigationViewV14x {
    ...
    override fun setEmptyMenuIds(emptyMenuIds: List<Int>): BottomNavigationViewV14x {
