...
class BottomNavigationViewV17x : BottomNavigationView,
    ...
    override fun setIconVisibility(visibility: Boolean): BottomNavigationViewV17x {
    ...
    override fun setTextVisibility(visibility: Boolean): BottomNavigationViewV17x {
    ...
    override fun enableAnimation(enable: Boolean): BottomNavigationViewV17x {
        for (b in theBottomNavigationItemViews) {
            val largeLabel: TextView = b.getFieldValue("largeLabel")
            val smallLabel: TextView = b.getFieldValue("smallLabel")
    ...
    override fun enableLabelVisibility(enable: Boolean): BottomNavigationViewV17x {
        labelVisibilityMode = if (enable) LABEL_VISIBILITY_SELECTED else LABEL_VISIBILITY_LABELED
        return this
    }
    
    override fun enableBNItemViewLabelVisibility(position: Int, enable: Boolean): BottomNavigationViewV17x {
        getBNItemView(position)?.setShifting(enable)
        return this
    }
    
    override fun enableItemHorizontalTranslation(enable: Boolean): BottomNavigationViewV17x {
    ...
    override fun setCurrentItem(index: Int): BottomNavigationViewV17x {
    ...
    override fun setMenuListener(menuListener: IMenuListener): BottomNavigationViewV17x {
        bnvHelper.setListener(menuListener)
        return this
    }
    
    override fun setMenuDoubleClickListener(menuDoubleClickListener: IMenuDoubleClickListener): BottomNavigationViewV17x {
    ...
    override fun clearIconTintColor(): BottomNavigationViewV17x {
    ...
    override fun setSmallTextSize(sp: Float): BottomNavigationViewV17x {
    ...
    override fun setLargeTextSize(sp: Float): BottomNavigationViewV17x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setTextSize(sp: Float): BottomNavigationViewV17x {
        setLargeTextSize(sp)
        setSmallTextSize(sp)
        return this
    }
    ...
    override fun setIconSize(width: Float, height: Float): BottomNavigationViewV17x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setIconSize(dpSize: Float): BottomNavigationViewV17x {
        itemIconSize = context.dp2px(dpSize)
        return this
    }
    
    override fun setBNMenuViewHeight(height: Int): BottomNavigationViewV17x {
        val lp = layoutParams
    ...
    override fun setTypeface(typeface: Typeface, style: Int): BottomNavigationViewV17x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setTypeface(typeface: Typeface): BottomNavigationViewV17x {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setBNItemViewBackgroundRes(position: Int, background: Int): BottomNavigationViewV17x {
        getBNItemView(position)?.setItemBackground(background)
        return this
    }
    
    override fun setIconTintList(tint: ColorStateList?): BottomNavigationViewV17x {
        theBottomNavigationMenuView.iconTintList = tint
        return this
    }
    
    override fun setIconTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV17x {
        getBNItemView(position)?.setIconTintList(tint)
        return this
    }
    
    override fun setTextTintList(tint: ColorStateList?): BottomNavigationViewV17x {
        theBottomNavigationMenuView.itemTextColor = tint
        return this
    }
    
    override fun setTextTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV17x {
        getBNItemView(position)?.setTextColor(tint)
        return this
    }
    
    override fun setIconsMarginTop(marginTop: Int): BottomNavigationViewV17x {
    ...
    override fun setIconMarginTop(position: Int, marginTop: Int): BottomNavigationViewV17x {
    ...
    override fun setEmptyMenuIds(emptyMenuIds: List<Int>): BottomNavigationViewV17x {
        bnvHelper.emptyMenuIds = emptyMenuIds
        return this
    }
    
    override fun configDynamic(count: Int, generator: (menu: Menu, index: Int) -> MenuItem): BottomNavigationViewV17x {
        if(count > 0) {
