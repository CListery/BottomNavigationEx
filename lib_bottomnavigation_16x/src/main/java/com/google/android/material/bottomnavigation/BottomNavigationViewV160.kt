...
class BottomNavigationViewV160 : BottomNavigationView,
    ...
    override fun setIconVisibility(visibility: Boolean): BottomNavigationViewV160 {
    ...
    override fun setTextVisibility(visibility: Boolean): BottomNavigationViewV160 {
    ...
    override fun enableAnimation(enable: Boolean): BottomNavigationViewV160 {
        for (b in theBottomNavigationItemViews) {
            val largeLabel: TextView = b.getField("largeLabel")
            val smallLabel: TextView = b.getField("smallLabel")
    ...
    override fun enableLabelVisibility(enable: Boolean): BottomNavigationViewV160 {
        labelVisibilityMode = if (enable) LABEL_VISIBILITY_SELECTED else LABEL_VISIBILITY_LABELED
        return this
    }
    
    override fun enableBNItemViewLabelVisibility(position: Int, enable: Boolean): BottomNavigationViewV160 {
        getBNItemView(position)?.setShifting(enable)
        return this
    }
    
    override fun enableItemHorizontalTranslation(enable: Boolean): BottomNavigationViewV160 {
    ...
    override fun setCurrentItem(index: Int): BottomNavigationViewV160 {
    ...
    override fun setMenuListener(menuListener: IMenuListener): BottomNavigationViewV160 {
        bnvHelper.setListener(menuListener)
        return this
    }
    
    override fun setMenuDoubleClickListener(menuDoubleClickListener: IMenuDoubleClickListener): BottomNavigationViewV160 {
    ...
    override fun clearIconTintColor(): BottomNavigationViewV160 {
    ...
    override fun setSmallTextSize(sp: Float): BottomNavigationViewV160 {
    ...
    override fun setLargeTextSize(sp: Float): BottomNavigationViewV160 {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setTextSize(sp: Float): BottomNavigationViewV160 {
        setLargeTextSize(sp)
        setSmallTextSize(sp)
        return this
    }
    ...
    override fun setIconSize(width: Float, height: Float): BottomNavigationViewV160 {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setIconSize(dpSize: Float): BottomNavigationViewV160 {
        itemIconSize = context.dp2px(dpSize)
        return this
    }
    
    override fun setBNMenuViewHeight(height: Int): BottomNavigationViewV160 {
    ...
    override fun setTypeface(typeface: Typeface, style: Int): BottomNavigationViewV160 {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setTypeface(typeface: Typeface): BottomNavigationViewV160 {
        val count = getBNItemViewCount()
        for (i in 0 until count) {
    ...
    override fun setBNItemViewBackgroundRes(position: Int, background: Int): BottomNavigationViewV160 {
        getBNItemView(position)?.setItemBackground(background)
        return this
    }
    
    override fun setIconTintList(tint: ColorStateList?): BottomNavigationViewV160 {
        theBottomNavigationMenuView.iconTintList = tint
        return this
    }
    
    override fun setIconTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV160 {
        getBNItemView(position)?.setIconTintList(tint)
        return this
    }
    
    override fun setTextTintList(tint: ColorStateList?): BottomNavigationViewV160 {
        theBottomNavigationMenuView.itemTextColor = tint
        return this
    }
    
    override fun setTextTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV160 {
        getBNItemView(position)?.setTextColor(tint)
        return this
    }
    
    override fun setIconsMarginTop(marginTop: Int): BottomNavigationViewV160 {
    ...
    override fun setIconMarginTop(position: Int, marginTop: Int): BottomNavigationViewV160 {
    ...
    override fun setEmptyMenuIds(emptyMenuIds: List<Int>): BottomNavigationViewV160 {
