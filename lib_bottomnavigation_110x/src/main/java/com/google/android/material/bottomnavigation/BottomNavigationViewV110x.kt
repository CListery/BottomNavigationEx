...
class BottomNavigationViewV110x : BottomNavigationView,
    ...
    override fun setIconVisibility(visibility: Boolean): BottomNavigationViewV110x {
    ...
    override fun setTextVisibility(visibility: Boolean): BottomNavigationViewV110x {
    ...
    override fun enableAnimation(enable: Boolean): BottomNavigationViewV110x {
        for(b in theBottomNavigationItemViews) {
            val largeLabel: TextView = b.getFieldValue("largeLabel")
            val smallLabel: TextView = b.getFieldValue("smallLabel")
    ...
    override fun enableLabelVisibility(enable: Boolean): BottomNavigationViewV110x {
        labelVisibilityMode = if(enable) LABEL_VISIBILITY_SELECTED else LABEL_VISIBILITY_LABELED
        return this
    }
    
    override fun enableBNItemViewLabelVisibility(position: Int, enable: Boolean): BottomNavigationViewV110x {
        getBNItemView(position)?.setShifting(enable)
        return this
    }
    
    override fun enableItemHorizontalTranslation(enable: Boolean): BottomNavigationViewV110x {
    ...
    override fun setCurrentItem(index: Int): BottomNavigationViewV110x {
    ...
    override fun setMenuListener(menuListener: IMenuListener): BottomNavigationViewV110x {
        bnvHelper.setListener(menuListener)
        return this
    }
    
    override fun setMenuDoubleClickListener(menuDoubleClickListener: IMenuDoubleClickListener): BottomNavigationViewV110x {
    ...
    override fun clearIconTintColor(): BottomNavigationViewV110x {
    ...
    override fun setSmallTextSize(sp: Float): BottomNavigationViewV110x {
    ...
    override fun setLargeTextSize(sp: Float): BottomNavigationViewV110x {
        val count = getBNItemViewCount()
        for(i in 0 until count) {
    ...
    override fun setTextSize(sp: Float): BottomNavigationViewV110x {
        setLargeTextSize(sp)
        setSmallTextSize(sp)
        return this
    }
    ...
    override fun setIconSize(width: Float, height: Float): BottomNavigationViewV110x {
        val count = getBNItemViewCount()
        for(i in 0 until count) {
    ...
    override fun setIconSize(dpSize: Float): BottomNavigationViewV110x {
        itemIconSize = context.dp2px(dpSize)
        return this
    }
    
    override fun setBNMenuViewHeight(height: Int): BottomNavigationViewV110x {
        val lp = layoutParams
    ...
    override fun setTypeface(typeface: Typeface, style: Int): BottomNavigationViewV110x {
        val count = getBNItemViewCount()
        for(i in 0 until count) {
    ...
    override fun setTypeface(typeface: Typeface): BottomNavigationViewV110x {
        val count = getBNItemViewCount()
        for(i in 0 until count) {
    ...
    override fun setBNItemViewBackgroundRes(position: Int, background: Int): BottomNavigationViewV110x {
        getBNItemView(position)?.setItemBackground(background)
        return this
    }
    
    override fun setIconTintList(tint: ColorStateList?): BottomNavigationViewV110x {
        theBottomNavigationMenuView.iconTintList = tint
        return this
    }
    
    override fun setIconTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV110x {
        getBNItemView(position)?.setIconTintList(tint)
        return this
    }
    
    override fun setTextTintList(tint: ColorStateList?): BottomNavigationViewV110x {
        theBottomNavigationMenuView.itemTextColor = tint
        return this
    }
    
    override fun setTextTintList(position: Int, tint: ColorStateList?): BottomNavigationViewV110x {
        getBNItemView(position)?.setTextColor(tint)
        return this
    }
    
    override fun setIconsMarginTop(marginTop: Int): BottomNavigationViewV110x {
    ...
    override fun setIconMarginTop(position: Int, marginTop: Int): BottomNavigationViewV110x {
    ...
    override fun setEmptyMenuIds(emptyMenuIds: List<Int>): BottomNavigationViewV110x {
    ...
    override fun configDynamic(count: Int, generator: (menu: Menu, index: Int) -> MenuItem): BottomNavigationViewV110x {
        if(count > 0) {
